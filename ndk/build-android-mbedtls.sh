...
for android_arch in $BUILD_ARCHS; do
  ...
  rm CMakeCache.txt
  cmake -DCMAKE_SYSTEM_NAME=Android -DCMAKE_SYSTEM_VERSION=$android_api -DCMAKE_ANDROID_ARCH_ABI=$android_arch -DCMAKE_ANDROID_NDK=$ANDROID_NDK_ROOT -DENABLE_TESTING=off -DCMAKE_INSTALL_PREFIX=$android_prefix  .
