...
for android_arch in $BUILD_ARCHS; do
  ...
  ./configure --host="$gcc_prefix" --disable-shared --enable-static --prefix="$android_prefix" --disable-debug-mode CFLAGS="$android_cflags" LDFLAGS="$android_libs" LIBS=" -lssl -lcrypto" 
