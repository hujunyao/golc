...
for android_arch in $BUILD_ARCHS; do
  ...
  ./configure --host="$gcc_prefix" --disable-openssl --disable-documentation  --disable-arm-neon --disable-mini-gmp --disable-shared --enable-static --prefix="$android_prefix" CFLAGS="$android_cflags" LDFLAGS="$android_libs"
