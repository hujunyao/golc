...
for android_arch in $BUILD_ARCHS; do
  ...
  ./configure --host="$gcc_prefix" --disable-doc --disable-shared --enable-static --prefix="$android_prefix" CFLAGS="$android_cflags" LDFLAGS="$android_libs" --with-libgpg-error-prefix="$android_prefix"
