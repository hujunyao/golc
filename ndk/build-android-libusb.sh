...
for android_arch in $BUILD_ARCHS; do
  ...
  ./configure --host="$gcc_prefix" --disable-shared --enable-static --disable-udev --disable-log --prefix="$android_prefix" CFLAGS="$android_cflags" LDFLAGS="$android_libs"
