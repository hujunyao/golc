...
for android_arch in $BUILD_ARCHS; do
  ...
  ./configure --host="$gcc_prefix" --disable-shared --enable-static --disable-ssl2-support --disable-ssl3-support --disable-fips140-mode --without-nettle-mini --disable-doc --disable-cxx --disable-tests --disable-full-test-suite --without-tpm --without-p11-kit --prefix="$android_prefix" CFLAGS="$android_cflags" LDFLAGS="$android_libs" LIBS=" -lnettle" --with-libiconv-prefix="$android_prefix"  --with-libunistring-prefix="$android_prefix"
